  ...
  return (
    <main className={`${garamond.className} bg-bgBlue w-full h-full`}>
      <div className='z-50 absolute flex-row items-center content-center justify-between p-12 lg:justify-start h-full'>
          ...
          <div className='flex-col space-y-4  mt-4'>
            ...
            <div>
              <div aria-describedby='link to a music on spotify'>
                <input
                  placeholder='Paste the link to a song on Spotify'
                  className='text-base border border-x-0 border-t-0 text-bgBlue px-4 py-2 min-w-box
                   bg-white border-black
                   placeholder:text-bgBlue font-normal focus:border-x-0 focus:border-t-0
        ...
        {/* //  <div class="song-list">
  //       <p>Most popular visualized songs</p>
  //    <div class="list-card">
  //       <div class="song-cover"><img src="/src/images/coverart.jpeg"/></div>
  //       <div class="play-icon"><img src="/src/images/icons8-play-button-16.png"/></div>
